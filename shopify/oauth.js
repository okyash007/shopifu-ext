...
export async function authorize(shop) {
  ...
  return encodeURI(
    `https://${shop}/admin/oauth/authorize?client_id=${app.api_key}&scope=read_customers,read_orders,read_products,read_script_tags,read_themes,write_draft_orders,write_order_edits,write_orders,write_products,write_script_tags,write_themes&redirect_uri=https://shopify.tailboost.ai/api/shopify/redirect`
  );
}
